...
public class CalculatorGUI {
    ...
    public CalculatorGUI() {
        ...
        makeScientificPanel();
        //tab
        JTabbedPane calTab = new JTabbedPane();
        ImageIcon iconOfCal = new ImageIcon(getClass().getResource("cal.jpg"));
        ImageIcon iconOfSt = new ImageIcon(getClass().getResource("st.gif"));
        ImageIcon iconOfSc = new ImageIcon(getClass().getResource("sc.gif"));
        calTab.addTab("Standard ",iconOfSt, standard);
        calTab.addTab("Scientific ",iconOfSc,scientific);
        calcFrame.setIconImage(iconOfCal.getImage());
        calcFrame.add(calTab);
    ...
    private void makeStandardPanel() {
        ...
        display.setFont(new Font("Arial", Font.ITALIC, 36));
        ...
        ceButton.setBackground(Color.BLACK);
        ceButton.setText("CE");
        //Add
